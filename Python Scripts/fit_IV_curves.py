...
I_paper7x = 2.536 * (V_paper ** 7) - 6.787 * (V_paper ** 6) + 8.169 * (V_paper ** 5) - 5.692 * (
            V_paper ** 4) + 2.353 * (V_paper ** 3) - 0.5309 * (V_paper ** 2) + 0.05224 * V_paper - 0.0001475

# Polyfit
z = np.polyfit(V_reading_3/1000, i_reading_3/1000, 7)
p = np.poly1d(z)
print(p)
...
plt.plot(V_reading_3, p(V_reading_3 / 1000) * 1000, label='Curve fitting Diode 3', linewidth=1.5)
plt.plot(V_paper * 1000, I_paper * 1000, label='S. Hermour Et al.', linewidth=1.5)
